...
pub(super) fn build_metrics_response(
    ...
    MetricsResponse {
        ...
        streamed_proxy_responses: snapshot.streamed_proxy_responses,
        proxy_body_preview_truncations: snapshot.proxy_body_preview_truncations,
        http2_pool_evictions: snapshot.http2_pool_evictions,
        active_rules,
        sqlite_enabled,
        ...
        runtime_server_mode: runtime_pressure.server_mode.to_string(),
        runtime_server_mode_scale_percent: runtime_pressure.server_mode_scale_percent,
        runtime_server_mode_reason: runtime_pressure.server_mode_reason.to_string(),
