...
include!("store/rules_repo.rs");
include!("store/config_repo.rs");
include!("store/sites_repo.rs");
include!("store/safeline_repo.rs");
include!("store/events_repo.rs");
include!("store/ops_repo.rs");
