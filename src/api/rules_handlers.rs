...
fn builtin_action_idea_presets() -> Vec<BuiltinActionIdeaPreset> {
    vec![
        ...
        BuiltinActionIdeaPreset {
            ...
            title: "内嵌JS",
            mood: "交互",
            summary: "返回一个带内嵌 JavaScript 的 HTML 页面，用于轻量前端提示或跳转逻辑。",
            mechanism: "直接用 HTML respond 返回页面，在页面中内嵌 <script> 完成交互。",
            performance: "中",
            fallback_path: "/admin/rules",
            ...
            plugin_description: "带内嵌 JavaScript 的响应页面示例动作",
            template_local_id: "inline_js",
            template_description: "返回包含内嵌 JavaScript 的 HTML 页面",
