    ...
    <div class="mt-4 flex flex-wrap items-center gap-x-6 gap-y-3">
      ...
      >
        ...
        <input
          ...
          class="ui-switch"
          @change="
            controls.handleHttp10Toggle(($event.target as HTMLInputElement).checked)
          "
        />
      </label>
      <label
      ...
      >
        <span>启用 HTTP/2</span>
        <input v-model="controls.http2Enabled.value" type="checkbox" class="ui-switch" />
      </label>
      <label
        class="inline-flex items-center justify-start gap-3 text-sm text-stone-800"
      >
        ...
        <input
          ...
          class="ui-switch"
          @change="
            updateDropUnmatchedRequests(($event.target as HTMLInputElement).checked)
          "
        />
      </label>
      <label
      ...
      >
        <span>启用 Bloom</span>
        <input v-model="controls.bloomEnabled.value" type="checkbox" class="ui-switch" />
      </label>
      <label
        class="inline-flex items-center justify-start gap-3 text-sm text-stone-800"
      >
        <span>启用上游健康检查</span>
        <input v-model="controls.healthcheckEnabled.value" type="checkbox" class="ui-switch" />
      </label>
      <label
        class="inline-flex items-center justify-start gap-3 text-sm text-stone-800"
      >
      ...
      >
        <span>启用 HTTP/3</span>
        <input v-model="controls.http3Enabled.value" type="checkbox" class="ui-switch" />
      </label>
      <label
        class="inline-flex items-center justify-start gap-3 text-sm text-stone-800"
      >
