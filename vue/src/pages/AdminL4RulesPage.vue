    ...
    <div class="space-y-6">
      ...
      <section class="grid gap-4 md:grid-cols-3">
        <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
          <p class="text-xs tracking-wider text-slate-500">L4 规则总数</p>
          ...
          >
            <div>
              ...
              <p class="mt-1 text-xs leading-5 text-slate-500">
                L4 规则会匹配类似 `source_ip=1.1.1.1 dest_port=443 protocol=TCP`
                这样的摘要，不是 `tcp:22` 这类简写。
              </p>
            </div>
