...
pub(super) async fn build_ai_audit_summary(
    ...
    Ok(AiAuditSummaryResponse {
        ...
        counters: AiAuditCountersResponse {
            ...
            l7_ip_access_allows: metrics.l7_ip_access_allows,
            l7_ip_access_alerts: metrics.l7_ip_access_alerts,
            l7_ip_access_challenges: metrics.l7_ip_access_challenges,
            l7_ip_access_blocks: metrics.l7_ip_access_blocks,
            l7_ip_access_verified_passes: metrics.l7_ip_access_verified_passes,
