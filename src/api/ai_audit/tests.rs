...
fn sample_summary() -> AiAuditSummaryResponse {
    AiAuditSummaryResponse {
        ...
        current: AiAuditCurrentStateResponse {
            ...
            runtime_defense_base_stage: "tighten".to_string(),
            runtime_defense_stage: "tighten".to_string(),
            runtime_defense_stage_score: 2,
            runtime_defense_stage_reason: "runtime_elevated,adaptive_high".to_string(),
            ...
            auto_tuning_recovery_windows: 1,
            auto_tuning_pressure_memory_windows: 1,
            identity_pressure_percent: 3.5,
            l7_friction_pressure_percent: 12.0,
            slow_attack_pressure_percent: 0.0,
            challenge_issued: 4,
            challenge_verified: 3,
            challenge_verify_rate_percent: 75.0,
            challenge_block_rate_percent: 25.0,
        },
        counters: AiAuditCountersResponse {
            ...
            l7_ip_access_allows: 0,
            l7_ip_access_alerts: 0,
            l7_ip_access_challenges: 0,
            l7_ip_access_blocks: 0,
            l7_ip_access_verified_passes: 0,
