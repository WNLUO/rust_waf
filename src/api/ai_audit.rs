...
fn build_localization_system_prompt() -> String {
    [
        "你是一个 JSON 本地化助手。",
        "你会收到一个 AI 审计结果 JSON。",
...
fn build_localization_user_prompt(output: &AiAuditModelOutput) -> anyhow::Result<String> {
    Ok(format!(
...
fn model_output_needs_chinese_localization(output: &AiAuditModelOutput) -> bool {
...
fn text_needs_chinese_localization(value: &str) -> bool {
