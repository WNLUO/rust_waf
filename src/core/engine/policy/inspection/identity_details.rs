...
pub(super) fn build_request_identity_details_with_header(
    ...
    let payload = json!({
        ...
        "inspection_runtime": {
            ...
            "runtime_defense_base_stage": request.get_metadata("runtime.defense.base_stage").cloned(),
            "runtime_defense_stage": request.get_metadata("runtime.defense.stage").cloned(),
            "runtime_defense_stage_score": request.get_metadata("runtime.defense.stage_score").cloned(),
            "runtime_defense_stage_reason": request.get_metadata("runtime.defense.stage_reason").cloned(),
            "runtime_defense_effective_reason": request.get_metadata("runtime.defense.effective_reason").cloned(),
