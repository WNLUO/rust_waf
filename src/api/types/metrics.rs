...
pub struct MetricsResponse {
    ...
    pub(crate) early_defense_drops_total: u64,
    pub(crate) early_defense_spoofed_forward_header_drops: u64,
    pub(crate) early_defense_trusted_cdn_unresolved_drops: u64,
    pub(crate) early_defense_l4_request_budget_drops: u64,
    pub(crate) early_defense_l4_high_risk_drops: u64,
    pub(crate) early_defense_l4_suspicious_drops: u64,
    pub(crate) early_defense_other_drops: u64,
    pub(crate) l7_drop_reason_cc_hot_block: u64,
    pub(crate) l7_drop_reason_cc_fast_block: u64,
    pub(crate) l7_drop_reason_cc_hard_block: u64,
    pub(crate) l7_drop_reason_spoofed_forward_header: u64,
    pub(crate) l7_drop_reason_behavior_aggregate: u64,
    pub(crate) l7_drop_reason_behavior_route_burst: u64,
    pub(crate) l7_drop_reason_l7_bloom_filter: u64,
    pub(crate) l7_drop_reason_blocked_client_ip: u64,
    pub(crate) l7_drop_reason_other: u64,
    ...
    pub(crate) l7_cc_fast_path_requests: u64,
    pub(crate) l7_cc_fast_path_blocks: u64,
    pub(crate) l7_cc_fast_path_challenges: u64,
    pub(crate) l7_cc_fast_path_no_decisions: u64,
    pub(crate) l7_cc_hot_cache_hits: u64,
    pub(crate) l7_cc_hot_cache_misses: u64,
    pub(crate) l7_cc_hot_cache_expired: u64,
    pub(crate) l7_cc_fast_path_ratio_percent: f64,
    ...
    pub(crate) streamed_proxy_responses: u64,
    pub(crate) proxy_body_preview_truncations: u64,
    pub(crate) http2_pool_evictions: u64,
    ...
    pub(crate) runtime_server_mode: String,
    pub(crate) runtime_server_mode_scale_percent: u32,
    pub(crate) runtime_server_mode_reason: String,
    ...
    pub(crate) runtime_pressure_cpu_percent: f64,
    pub(crate) runtime_pressure_cpu_score: u8,
    pub(crate) runtime_pressure_cpu_sample_available: bool,
    ...
    pub(crate) resource_sentinel_ingress_gap_analysis:
        crate::core::ResourceSentinelIngressGapAnalysis,
    pub(crate) resource_sentinel_resource_pressure_feedback:
        crate::core::ResourceSentinelResourcePressureFeedback,
    pub(crate) resource_sentinel_attack_migrations:
        Vec<crate::core::ResourceSentinelAttackMigration>,
    pub(crate) resource_sentinel_attack_report_preview:
        Option<crate::core::ResourceSentinelAttackReport>,
...
pub struct L7StatsResponse {
    ...
    pub(crate) cc_fast_path_requests: u64,
    pub(crate) cc_fast_path_blocks: u64,
    pub(crate) cc_fast_path_challenges: u64,
    pub(crate) cc_fast_path_no_decisions: u64,
    pub(crate) cc_hot_cache_hits: u64,
    pub(crate) cc_hot_cache_misses: u64,
    pub(crate) cc_hot_cache_expired: u64,
    pub(crate) cc_fast_path_ratio_percent: f64,
